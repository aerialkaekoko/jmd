...
<div class="card">
    ...
    <div class="card-body">
        ...
        <hr/>
        <form action="{{ route("admin.exchanges.update", [$exchange->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <input type="hidden" name="medical_exchange" value="{{$medical_exchange}}">
            <input type="hidden" name="user_id" value="{{$user_id}}">
            <div class="row">                
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('exchange_usd') ? 'has-error' : '' }}">
                        <label for="name">USD</label>
                        <input type="text" id="exchange_usd" name="exchange_usd" class="form-control text-right" onkeypress="return isNumberKey(event)" value="{{ $exchange->exchange_usd}}">
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('exchange_thb') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="exchange_thb" name="exchange_thb" class="form-control text-right" onkeypress="return isNumberKey(event)" value="{{ $exchange->exchange_thb}}">
            ...
            <div class="row">                
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('exchange_mmk') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="exchange_mmk" name="exchange_mmk" class="form-control text-right" onkeypress="return isNumberKey(event)" value="{{ $exchange->exchange_mmk}}">
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('exchange_lak') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="exchange_lak" name="exchange_lak" class="form-control text-right" onkeypress="return isNumberKey(event)" value="{{ $exchange->exchange_lak}}">
