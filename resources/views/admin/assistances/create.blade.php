...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.assistance.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.assistances.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">                    
                    <div class="form-group {{ $errors->has('short_code') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="short_code" name="short_code" class="form-control" value="{{ old('short_code', isset($insurance) ? $insurance->short_code : '') }}" >
