            ...
            <div class="row">                
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('exchange_thb') ? 'has-error' : '' }}">
                        ...
                        <input type="number" id="exchange_thb" name="exchange_thb" class="form-control text-right" value="{{ $exchange->exchange_thb}}">
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('exchange_lak') ? 'has-error' : '' }}">
                        ...
                        <input type="number" id="exchange_lak" name="exchange_lak" class="form-control text-right" value="{{ $exchange->exchange_lak}}">
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('exchange_mmk') ? 'has-error' : '' }}">
                        ...
                        <input type="number" id="exchange_mmk" name="exchange_mmk" class="form-control text-right" value="{{ $exchange->exchange_mmk}}">
