...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.doctors.title_singular') }}
    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="name" name="name" class="form-control" value="{{ old('name', isset($doctors) ? $doctors->name : '') }}" required>
                        @if($errors->has('name'))
                            <p class="help-block">
                                {{ $errors->first('name') }}
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('specialist') ? 'has-error' : '' }}">
                        <label for="specialist">{{ trans('cruds.doctors.fields.specialist') }}</label>
                        {{--
                        <input type="text" id="specialist" name="specialist" class="form-control" value="{{ old('specialist', isset($doctors) ? $doctors->specialist : '') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('schedule') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="schedule" name="schedule" class="form-control" value="{{ old('schedule', isset($doctors) ? $doctors->schedule : '') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                        ...
                        {{-- 
                        <input type="text" id="country" name="country" class="form-control" value="{{ old('country', isset($doctors) ? $doctors->country : '') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('contact') ? 'has-error' : '' }}">
                        <label for="contact">{{ trans('cruds.doctors.fields.contact') }}</label>
                         <input type="text" id="contact" name="contact" class="form-control" value="{{ old('contact', isset($doctors) ? $doctors->contact : '') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="address" name="address" class="form-control" value="{{ old('address', isset($doctors) ? $doctors->address : '') }}">
