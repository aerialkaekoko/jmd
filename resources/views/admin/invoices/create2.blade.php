...
@endsection
@section('content')
<form action="{{route('admin.invoices.storeform2')}}" method="post">
    @csrf
    ...
    <div class="card">
        <h1 class="text-center">Invoice Form 2</h1>
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="insurance"
                                value="{{isset($medical_information)&& $medical_information->insurance ? $medical_information->insurance->company_name: '-'}}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="assistance"
                                value="{{isset($medical_information)&& $medical_information->assistance ? $medical_information->assistance->assistance_name: '-'}}"
                                readonly>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body repeater">
            <table class="table table-borderless" id="tab_logic">
                ...
                <tbody data-repeater-list="data">
                    @foreach($medical_information_item as $key=>$item)
                    ...
                    <tr data-repeater-item>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="ba_ref_no" name="ba_ref_no"
                                        value="{{$item->ba_ref_no}}" data-srno="{{$tkey}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="patient_name" name="patient_name"
                                        value="{{ $item->user->family_name }} {{ $item->user->name }}"
                                        data-srno="{{$tkey}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="treatment_date" name="treatment_date"
                                        value="{{isset($medical_information) ? $medical_information->date_of_visit: 0}}"
                                        data-srno="{{$tkey}}">
                                </div>
                            </div>
                            <div class="form-group row" style="display: none;">
                                <label for="Patient Name" class="col-sm-5 col-form-label">Branch Code :</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="branch_code" name="branch_code"
                                       value="{{isset($medical_information) ? $medical_information->hospital->country_code: 0}}"
                                        data-srno="{{$tkey}}">
                                </div>
                            </div>
                        </td>
                        <td class="p-1">
                            ...
                            <div class="form-group">
                                <input  data-repeater-delete type="button" class="btn btn-md btn-danger deleterow" value="x" name="deleteItem" id="deleteItem"/>
                            </div>
                        </td>
                        <td class="p-1">
                            <input type="text" name="md_expense" id="md_expense" class="form-control md_expense"
                                value="{{$item->medical_amount}}" min="0" step="0" value="0" />
                            <input type="text" class='mdtotal hide'>
                        </td>
                        <td class="p-1">
                            <select class="form-control currency" name="currency1" id="currency1" >
                                @foreach (trans('cruds.currency') as $key=>$value)
                                <option value="{{$key}}" {{($item->currency == $key)?'selected':''}}>{{$value}}</option>
                                @endforeach
                            </select>
                        </td>
                        <td class="p-1">
                            <input type="text" name="interpreter_fee" id="interpreter_fee"
                                class="form-control interpreter_fee" data-srno="{{$tkey}}" min="0" step="0" value="0">
                            <input type="text" class='interperetertotal hide'>
                        </td>
                        <td class="p-1">
