...
@section('content')
<form action="{{route('admin.invoices.storeform1')}}" method="post">
    @csrf
    ...
    <input type="hidden" name="medical_information_id" class="form-control md_id" id="md_id" value="{{isset($medical_information) ? $medical_information->id: 0}}" readonly>
    <input type="hidden" name="user_id" class="form-control user_id" id="user_id" value="{{isset($medical_information) ? $medical_information->user->id: 0}}" readonly>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="invoice_code" name="invoice_code" value="{{$invoice_code}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="Ba Ref No" class="col-sm-4 col-form-label">BA REF NO :</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="ba_ref_no" value="{{isset($medical_information) ? $medical_information->ba_ref_no : ''}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="Case No" class="col-sm-4 col-form-label">Case No :</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="case_no" value="{{isset($medical_information) ? $medical_information->gcl_case_no: '-'}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="Patient Name" class="col-sm-4 col-form-label">Patient Name :</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="patient_name" value="{{isset($medical_information) ? $medical_information->user->family_name.' '.$medical_information->user->name : ''}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row" style="display: none;">
                        <label for="branch_code" class="col-sm-4 col-form-label">Branch Code :</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="branch_code" id="branch_code" value="{{isset($medical_information) ? $medical_information->hospital->country_code : ''}}" readonly="">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                                ...
                                <input type="text" class="form-control md_expense" id="md_expense" value="{{isset($medical_information) ? $medical_information->medical_amount: 0}}" readonly>
                         
                               
                                <select class="form-control mdcurrency" id='md_currency' disabled>
                                    @foreach (trans('cruds.currency') as $key=>$value)
                                    <option value="{{$key}}" {{($medical_information->currency == $key)?'selected':''}}>{{$value}}</option>
                                    @endforeach
                                </select>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="invoice_date" name="invoice_date" value="{{date('Y-m-d')}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="Insurance" class="col-sm-4 col-form-label">Insurance :</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="insurance" value="{{isset($medical_information)&& $medical_information->insurance ? $medical_information->insurance->company_name: '-'}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="Assistance" class="col-sm-4 col-form-label">Asstc. Co. :</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="assistance" value="{{isset($medical_information)&& $medical_information->assistance ? $medical_information->assistance->assistance_name: '-'}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="treatment_date" value="{{isset($medical_information) ? $medical_information->treatment_date: 0}}" readonly>
                        </div>
                    </div>                    
                </div>
            </div>
            ...
            <div class="row" id="ipd_opd">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="ipd_start_date" value="{{isset($medical_information) ? $medical_information->ipd_start_date: 0}}" readonly>
                        </div>
                    </div>                    
                </div>
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="ipd_finish_date" name="ipd_finish_date" value="{{isset($medical_information) ? $medical_information->ipd_finish_date: 0}}" readonly>
                        </div>
                    </div>          
                </div>
            </div>
            ...
            <table class="table table-borderless description_table" id='tab_logic'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="p-1"><input type="text" name="data[{{$i}}][unit_price]" class="unit_price form-control" id="unit_price{{$i}}" data-id="{{$i}}"  min="0" step="0" value="0"></td>
                        <td class="p-1">
                        ...
                        <td class="p-1">
                            <input type="text" name="data[{{$i}}][amount]" id="amount{{$i}}" class="form-control amount" min="0" step="0" value="0" readonly>
                        </td>
                        <td class="p-1">
                        ...
                        <td class="p-1 text-center">
                            <input type="checkbox"  value="0" id="vatable{{$i}}" class="cvatabel ml-auto" vatableamount="0">
        ...
        <table class="table table-bordered table-hover" id="tab_logic_total">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><input type="number" name='Grand Total' id="total_amount" placeholder='0.00'
