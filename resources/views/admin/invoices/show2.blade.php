...
<form action="{{route('admin.invoices.updateform2',[$invoice->id])}}" method="post">
    ...
    <div class="card">
        <h1 class="text-center">show Invoice Form 2</h1>
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="to" id="to" class="form-control" disabled>
                                ...
                                <option value="{{$key}}" @if($key==$invoiceassistance_id) selected @endif> {{$value}}
                                </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control" id="send_date" name="send_date"
                                value="{{isset($invoice) ? $invoice->send_date: ''}}" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control" id="paid_date" name="paid_date"
                                value="{{isset($invoice) ? $invoice->paid_date: ''}}" disabled>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <tr data-repeater-item>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="ba_ref_no" name="ba_ref_no"
                                        value="{{ App\MedicalInformation::find($item->medical_information_id)->ba_ref_no }}"
                                        data-srno="{{$tkey}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="patient_name" name="patient_name"
                                        value="{{ App\MedicalInformation::find($item->medical_information_id)->user->family_name }} {{ App\MedicalInformation::find($item->medical_information_id)->user->name }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <td class="p-1">
                            <div class="form-group">
                                <select name="qty" id="qty" class="qty form-control" disabled>
                                    @for ($qty = 1; $qty < 21; $qty++) <option value="{{$qty}}" @if($qty==$item->qty)
                                        selected @endif>{{$qty}}</option>
                                        @endfor
                                </select>
                            </div>
                            {{-- <div class="form-group">
                                <input data-repeater-delete type="button" class="btn btn-md btn-danger" value="x"
                                    name="deleteItem" id="deleteItem" />
                            </div> --}}
                        </td>
                        <td class="p-1">
                            <input type="text" name="md_expense" id="md_expense" class="form-control md_expense"
                                value="{{App\MedicalInformation::find($item->medical_information_id)->medical_amount}}"
                                min="0" step="0" value="0" readonly/>
                            <input type="text" class='hide mdtotal'>
                        </td>
                        <td class="p-1">
                            <select class="form-control currency2" name="currency1" id="currency1" disabled>
                                @foreach (trans('cruds.currency') as $key=>$value)
                                <option value="{{$key}}"
                                    {{(App\MedicalInformation::find($item->medical_information_id)->currency == $key)?'selected':''}}>
                                    {{$value}}</option>
                                @endforeach
                            </select>
                        </td>
                        <td class="p-1">
                            <input type="text" name="interpreter_fee" id="interpreter_fee"
                                class="form-control interpreter_fee" data-srno="{{$tkey}}" min="0" step="0"
                                value="{{$item->interpreter_fee}}" readonly>
                            <input type="text" class='hide interperetertotal'>
                        </td>
                        <td class="p-1">
                            <select class="form-control currency" name="currency1" id="currency1" disabled>
                                @foreach (trans('cruds.currency') as $key=>$value)
                                <option value="{{$key}}"
                                    {{(App\MedicalInformation::find($item->medical_information_id)->currency == $key)?'selected':''}}>
                                    {{$value}}
                        ...
                        <td class="p-1">
                            <select class="totalcurrency form-control" disabled>
                                <option value="">select currency</option>
                                @foreach (trans('cruds.currency') as $key=>$value)
                                <option value="{{$key}}" {{($item->change_currency == $key)?'selected':''}}>{{$value}}
                                </option>
                                @endforeach
                            </select>
                        </td>
            ...
            <table class="table table-bordered table-hover" id="tab_logic_total">
                <tbody>
                    <tr>
                        ...
                        <td class="">
                            <select class="totalcurrency form-control" disabled>
                                ...
                                @foreach (trans('cruds.currency') as $key=>$value)
                                <option value="{{$key}}" {{("$changecurrency" == $key)?'selected':''}}>{{$value}}
                                </option>
                                @endforeach
                            </select>
                        </td>
                    ...
                    <tr>
                        <th>
                            vat
                            <select name="vat_percent" id="vat_percent" class="vat_percent" disabled>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="totalcurrency form-control" name="totalcurrency" disabled>
                                <option>select currency</option>
                                @foreach (trans('cruds.currency') as $key=>$value)
                                <option value="{{$key}}" {{("$changecurrency" == $key)?'selected':''}}>{{$value}}
                                </option>
