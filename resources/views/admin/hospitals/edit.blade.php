...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.hospitals.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.hospitals.update", [$hospital->id]) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                  ...
                  <p class="helper-block">
                      {{ trans('cruds.hospitals.fields.name_helper') }}
                  </p>
              </div>
              </div>
            </div>
                ...
                <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                    ...
                    <select name="country" id="country" class="form-control" required>
                        @foreach(trans( 'cruds.countries' ) as $id => $country)
                            <option value="{{ $id }}" {{ old( 'country', $hospital->country)===$id ? 'selected' : '' }}>{{ $country }}</option>
                        @endforeach
                    </select>
                    <p class="helper-block">
                        {{ trans('cruds.hospitals.fields.country_helper') }}
                    </p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group {{ $errors->has('country_code') ? 'has-error' : '' }}">
                  ...
                  <input type="text" id="country_code" name="country_code" class="form-control" value="{{ old('country_code', isset($hospital) ? $hospital->country_code : '') }}">
                  ...
                  @endif
                  <p class="helper-block">
                      {{ trans('cruds.hospitals.fields.country_code_helper') }}
                  </p>
              </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                  ...
                  <input type="text" id="address" name="address" class="form-control" value="{{ old('name', isset($hospital) ? $hospital->address : '') }}">
                  ...
                  @endif
                  <p class="helper-block">
                      {{ trans('cruds.hospitals.fields.address_helper') }}
                  </p>
              </div>
              </div>
              <div class="col-md-6">
                <div class="form-group {{ $errors->has('contact') ? 'has-error' : '' }}">
                    <label for="contact">{{ trans('cruds.hospitals.fields.contact') }}</label>
                      <input type="text" id="contact" name="contact" class="form-control" value="{{ old('name', isset($hospital) ? $hospital->contact : '') }}">
            ...
            <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                ...
                <textarea id="description" name="description" class="form-control ckeditor">{{ old('description', isset($hospital) ? $hospital->description : '') }}</textarea>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.hospitals.fields.description_helper') }}
                </p>
            </div>            
