                ...
                <tbody>
                    @foreach($departments as $key => $department)
                        <tr data-entry-id="{{ $department->id }}">
                            ...
                            <td>
                                @can('department_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.departments.show', $department->id) }}" data-toggle="tooltip" data-placement="top" title="Detail">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                @endcan

                                @can('department_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.departments.edit', $department->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
