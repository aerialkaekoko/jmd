...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#permission_users" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="permission_users">
            @includeIf('admin.permissions.relationships.permissionUsers', ['users' => $permission->permissionUsers])
        </div>
    </div>
</div>
